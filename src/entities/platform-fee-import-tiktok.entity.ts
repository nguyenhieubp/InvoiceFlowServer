...
@Entity('platform_fee_import_tiktok')
@Index(['maSan', 'ngayDoiSoat'])
export class PlatformFeeImportTiktok {
  ...
  // TikTok fee columns (each fee has its own accounting code embedded in the name)
  @Column({
    name: 'phi_giao_dich',
    type: 'decimal',
    precision: 15,
  ...
  phiGiaoDichTyLe5164020: number | null;

  @Column({
    name: 'phi_hoa_hong_tra_cho_tiktok',
    type: 'decimal',
    precision: 15,
    scale: 2,
    nullable: true,
  })
  phiHoaHongTraChoTiktok454164020: number | null;
  ...
  phiHoaHongTiepThiLienKet150050: number | null;
  ...
  phiDichVuSfp6164020: number | null;
