...
export class OrderFeeController {
  ...
  async findShopeeFees(
    ...
    const result = await this.orderFeeService.findShopeeFees(page, limit, brand, search, startDate, endDate);
    return {
      data: result.data,
      meta: {
        total: result.total,
  ...
  async findTikTokFees(
    ...
    const result = await this.orderFeeService.findTikTokFees(page, limit, brand, search, startDate, endDate);
    return {
      data: result.data,
      meta: {
        total: result.total,
