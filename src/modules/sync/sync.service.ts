      ...
      for (const cash of cashData) {
        try {
          ...
          const cashioData: Partial<DailyCashio> = {
            ...
            invoice_no: cash.invoice_no || undefined,
            invoice_code: cash.invoice_code || undefined,
            ...
            description: cash.description || undefined,
            partner_type: cash.partner_type || undefined,
            cat_sys_code: cash.cat_sys_code || undefined,
            shift_code: cash.shift_code || undefined,
